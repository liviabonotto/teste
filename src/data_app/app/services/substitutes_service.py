...
def sugerir_substituto_com_estoque(cod_prod_informado, cod_loja):
    ...
    try:
        ...
        # Debug: Verificar os primeiros registros do DataFrame
        ...
        # Certifique-se de que o tipo do código do produto seja consistente
        logger.info(f"Buscando produto com código {cod_prod_informado} no dataset.")
        try:
            cod_prod_informado = int(cod_prod_informado)  # Converter para inteiro, caso seja string
        except ValueError:
